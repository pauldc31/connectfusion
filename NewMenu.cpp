...
void CNewMenu::DrawItem_XP_2003(LPDRAWITEMSTRUCT lpDIS, BOOL bIsMenuBar)
{
  ...
  //COLORREF colorCheck    = RGB(212,213,216);
  //COLORREF colorCheckSel = RGB(133,146,181); 
  
  
  colorSel = RGB(255,238,194);
  COLORREF colorCheck    = RGB(211,212,221);
  COLORREF colorCheckSel = MixedColor(colorSel,RGB(136,139,165));
